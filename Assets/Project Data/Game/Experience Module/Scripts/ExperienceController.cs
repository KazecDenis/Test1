...
namespace Watermelon
{
    public class ExperienceController : MonoBehaviour
    {
        ...
        public static int CurrentLevel
        {
            ...
            private set
            {
                instance.save.CurrentLevel = value;
                SaveLoad.SaveT(instance.save, "ExperienceSave");
            }
        }
        ...
        public static int ExperiencePoints
        {
            ...
            private set
            {
                instance.save.CurrentExperiencePoints = value;
                SaveLoad.SaveT(instance.save, "ExperienceSave");
            }
        }
        ...
        public void Initialise()
        {
            ...
            save = SaveLoad.LoadT<ExperienceSave>("ExperienceSave");
