...
namespace Watermelon.SquadShooter
{
    public class WeaponsController : MonoBehaviour
    {
        ...
        public static int SelectedWeaponIndex
        {
            ...
            private set
            {
                save.selectedWeaponIndex = value;
                SaveLoad.SaveT(save, "weapon_save");
            }
        }
        ...
        public void Initialise()
        {
            ...
            save = SaveLoad.LoadT<GlobalWeaponsSave>("weapon_save");
            Debug.Log("111111111111111111    " + save.selectedWeaponIndex );
...
//         }
        ...
        public static void AddCard(WeaponType weaponType, int amount)
        {
            for (int i = 0; i < weapons.Length; i++)
            {
                if (weapons[i].Type == weaponType)
                {
                    ...
                    SaveLoad.SaveT(weapons[i].Save, $"Weapon_{weapons[i].Type}");
                    break;
                }
            }
        ...
        public static void AddCards(List<WeaponType> cards)
        {
            ...
            for (int i = 0; i < cards.Count; i++)
            {
                ...
                SaveLoad.SaveT(weapon.Save, $"Weapon_{weapon.Type}");
            }
        ...
        {
            return instance.database.GetWeaponByIndex(SelectedWeaponIndex);
        }
