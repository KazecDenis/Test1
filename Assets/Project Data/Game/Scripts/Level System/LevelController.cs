...
//TODO:Save
            ...
            levelSave = SaveLoad.LoadT<LevelSave>("level");
        ...
        private static void IncreaseLevelInSave()
        {
            ...
            SaveLoad.SaveT(levelSave, "level");
        }
        ...
        {
            var area = TextTranslator.GetText("ЗОНА", "AREA");
            return $"{area} {ActiveRoom.CurrentWorldIndex + 1}-{ActiveRoom.CurrentLevelIndex + 1}";
        }
